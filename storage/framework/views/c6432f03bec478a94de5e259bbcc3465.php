...
<section class="bg-green-700 text-white py-6">
    <div class="container mx-auto flex flex-col md:flex-row items-center justify-center gap-4 px-4">
        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" class="w-20 h-20 object-contain">
...
<section class="py-8 bg-white text-center">
    ...
    <div class="flex flex-wrap justify-center gap-4 px-4">
        <?php $__currentLoopData = [1,2,3,4,5,6,7,8]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="bg-green-100 rounded-md p-2 shadow-md w-40">
            <img src="<?php echo e(asset('images/kambing.png')); ?>" alt="<?php echo e(asset('images/images.jpg')); ?>" class="w-full rounded-md">
        </div>
...
<section class="py-10 bg-white text-center px-4">
    ...
    <div class="flex flex-wrap justify-center gap-4 mt-6">
        <img src="<?php echo e(asset('images/foto1.jpg')); ?>" alt="Peternakan 1" class="w-72 rounded-md shadow-md">
        <img src="<?php echo e(asset('images/foto2.jpg')); ?>" alt="Peternakan 2" class="w-72 rounded-md shadow-md">
    </div>
</section>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Documents\Semester 4\AgroIndustri\ProjectPPL\Goatbiz2\resources\views/homepage.blade.php ENDPATH**/ ?>