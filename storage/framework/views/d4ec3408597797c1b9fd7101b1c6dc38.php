    ...
    <div class="row">
        ...
        <div class="col-md-2 p-0" style="background: #22314e; min-height:100vh;">
            ...
            <ul class="nav flex-column mt-4">
                <li class="nav-item"><a class="nav-link text-white" href="<?php echo e(route('homepage')); ?>"><i class="fa fa-home"></i> Home</a></li>
                ...
                <li class="nav-item"><a class="nav-link text-white" href="<?php echo e(route('goat.diagnose')); ?>"><i class="fa fa-map-marker"></i> Deteksi Penyakit</a></li>
            </ul>
        </div>
        <!-- Main Content -->
        <div class="col-md-10">
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?php echo e(route('goat.diagnose')); ?>">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="mt-4">
                                    <?php if(count($results) > 0): ?>
                                        <div class="alert alert-success">
                                            ...
                                            <ul>
                                                <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $penyakit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li><?php echo e($penyakit); ?></li>
...
<?php echo $__env->make('layouts.dashboardAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Documents\Semester 4\AgroIndustri\ProjectPPL\Goatbiz2\resources\views/admin/goat-disease.blade.php ENDPATH**/ ?>