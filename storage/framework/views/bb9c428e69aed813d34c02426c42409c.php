...
unset($__errorArgs, $__bag); ?>" id="role" name="role" required>
                                ...
                                <option value="pemasok" <?php echo e(old('role') == 'pemasok' ? 'selected' : ''); ?>>Pemasok</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="kabupaten" class="form-control <?php $__errorArgs = ['kabupaten'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="kabupaten" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="detail_alamat" class="form-control <?php $__errorArgs = ['detail_alamat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="detail_alamat" required><?php echo e(old('detail_alamat')); ?></textarea>
                                <?php $__errorArgs = ['detail_alamat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH C:\Users\ASUS\Documents\Semester 4\AgroIndustri\ProjectPPL\Goatbiz2\resources\views/components/register.blade.php ENDPATH**/ ?>