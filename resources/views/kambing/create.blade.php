{{-- resources/views/kambing/create.blade.php --}}
@extends('layouts.app')
        ...
        <div class="col-md-8 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h4>Tambah Data Kambing</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('kambing.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        @else
                        <input type="hidden" name="pemasok_id" value="{{ Auth::guard('akun')->user()->profil->id }}">
                        @endif
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1"
                                       id="status_tersedia" name="status_tersedia" {{ old('status_tersedia') ? 'checked' : '' }}>
